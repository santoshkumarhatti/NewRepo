...
const faqs = [
  ...
  },
  {
    ...
    answer: "Yes, upon successful completion of a course, you will receive a verifiable certificate from Prime Leap Institute to showcase your new skills on your resume and LinkedIn profile."
  }
];
